...
class Kendaraan:
    def __init__(self, nomor_kendaraan, jenis_kendaraan, nama_kendaraan, nama_pemilik):
        self._nomor_kendaraan = nomor_kendaraan
        self._jenis_kendaraan = jenis_kendaraan
        self._nama_kendaraan = nama_kendaraan
        self._nama_pemilik = nama_pemilik
        self._tanggal_masuk = datetime.datetime.now().strftime('%d-%m-%Y')
        self._waktu_masuk = datetime.datetime.now().strftime('%H:%M:%S')
        self._tanggal_keluar = None
        self._waktu_keluar = None
...
class Sistem_Parkir:
    ...
    def lihat_kendara_terparkir(self):
        ...
        for kendaraan in self.kendaraan:
            count += 1
            data.append([
                kendaraan._nomor_kendaraan,
                kendaraan._jenis_kendaraan,
                kendaraan._nama_kendaraan,
                kendaraan._nama_pemilik,
                kendaraan._tanggal_masuk,
                kendaraan._waktu_masuk
            ])
...
class DialogMasukKendaraan(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.label_jenis_kendaraan = tk.Label(self, text="Jenis Kendaraan (Sepeda = A / Motor = B, / Mobil = C):")
